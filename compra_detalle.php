...
$sqlCompra = $con->prepare("SELECT id, id_transaccion, fecha, total, metodo_pago FROM compra WHERE id_transaccion =? LIMIT 1");
            ...
            <div class="col-12 col-md-4">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <p><strong>Metodo de pago: </strong><?php echo $rowCompra['metodo_pago']; ?></p>
                        ...
                        <tbody>
                            <?php while($row = $sqlDetalle->fetch(PDO::FETCH_ASSOC)){
                                ...
                                <tr>
                                    ...
                                    <td><?php echo MONEDA . number_format($precio, 2, '.', ','); ?></p>
                                    <td><?php echo $cantidad; ?></td>
                                    <td><?php echo MONEDA . number_format($subtotal, 2, '.', ','); ?></p>
